...
simPartenaire_T32 = anosim(m_comPartenaire_T32, dataPartenaireT32$N.Produit_Dose, distance = "euclidean", permutations = 9999);simPartenaire_T32
plot(simPartenaire_T32)

# Partenaire T40 ----
comPartenaire_T40 = dataPartenaireT40[,5]
m_comPartenaire_T40 = as.matrix(comPartenaire_T40)
simPartenaire_T40 = anosim(m_comPartenaire_T40, dataPartenaireT40$N.Produit_Dose, distance = "euclidean", permutations = 9999);simPartenaire_T40
